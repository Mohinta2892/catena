...
for idx, roi in tqdm(top_roi_bboxes.iterrows(), total=len(top_roi_bboxes)):
    ...
    outputpath = f"./sylee_neurotrans_cubes_202508-hemibrain_gt_data/{roi['max_neurotransmitter']}"  # change the path here based on brain region #bodyprepost_{roi['bodyId_pre']}_{roi['bodyId_post']} cutout{idx + 1}
