"""
Adapted  from original code and updated ``daisy`` and ``funlib.persistence`` dependencies.
Original code is here: https://github.com/funkelab/lsd/blob/master/lsd/post/parallel_fragments.py
"""
...
def parallel_watershed(
    ...
    Args:
        ...
        affs (`class:funlib.persistence.Array`): # now in funlib.persistence
        ...
        fragments_out (`class:funlib.persistence.Array`):
        ...
        mask (`class:funlib.persistence.Array`):
    ...
    task = daisy.Task(
        task_id='parallel_watershed',
        total_roi=total_roi,
        read_roi=read_roi,
        write_roi=write_roi,
        process_function=lambda b: watershed_in_block(
            affs=affs,
            block=b,
            context=context,
        ...
        check_function=lambda b: block_done(b, rag_provider),
