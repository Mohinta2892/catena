...
_C.DATA.BRAIN_VOL = "OCTO" #WASP_MITO  # datasets, options: HEMI;OCTO;SEYMOUR;LUCCHI;CREMI; expand this to load multiple datasets
...
_C.TRAIN.CHECKPOINT = f"/media/samia/DATA/ark/lsd_checkpoints/AFF_3D/run-aclsd-together/model_checkpoint_300000"
...
_C.INS_SEGMENT.THRESHOLDS = np.arange(0.45, 0.55, 0.05).tolist()
