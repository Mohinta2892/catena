...
_C.TRAIN.CHECKPOINT = f"{_C.DATA.HOME}/lsd_checkpoints/MTLSD_3D/FAFB_CLAHE/run_2/model_checkpoint_200000"
...
_C.MODEL_ANISO.KERNEL_SIZE_DOWN = None
# [[(1, 3, 3), (1, 3, 3)], [(3,) * 3, (3,) * 3], [(3,) * 3, (3,) * 3],[(3,) * 3, (3,) * 3]]
_C.MODEL_ANISO.KERNEL_SIZE_DOWN_2D = None
# [[(1, 3), (1, 3)], [(3,) * 2, (3,) * 2], [(3,) * 2, (3,) * 2],[(3,) * 2, (3,) * 2]]
