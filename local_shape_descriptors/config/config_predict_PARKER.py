...
_C.SYSTEM.NUM_WORKERS = 64
_C.SYSTEM.CACHE_SIZE = 6
...
_C.DATA.BRAIN_VOL = "PARKER"  # datasets, options: HEMI;OCTO;SEYMOUR;LUCCHI;CREMI; expand this to load multiple datasets
