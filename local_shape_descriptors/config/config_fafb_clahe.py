...
_C.DATA.BRAIN_VOL = "FAFB_CLAHE"  # datasets, options: HEMI;OCTO;SEYMOUR;LUCCHI;CREMI; expand this to load multiple datasets
...
_C.MODEL_ANISO.DOWNSAMPLE_FACTORS = [[1, 2, 2], [2, 2, 2], [2, 2, 2]]  # features shape [22,22,22]
_C.MODEL_ANISO.DOWNSAMPLE_FACTORS_2D = [[1, 2], [2, 2], [3, 3]]
_C.MODEL_ANISO.NUM_FMAPS_OUT = 14
_C.MODEL_ANISO.KERNEL_SIZE_DOWN = None  # [[(1, 3, 3), (1, 3, 3)], [(1, 3, 3), (1, 3, 3)], [(3,) * 3, (3,) * 3], [(3,) * 3, (3,) * 3]]
_C.MODEL_ANISO.KERNEL_SIZE_DOWN_2D = [[(1, 3), (1, 3)], [(3,) * 2, (3,) * 2], [(3,) * 2, (3,) * 2],
                                      [(3,) * 2, (3,) * 2]]
_C.MODEL_ANISO.KERNEL_SIZE_UP = None  # [[(3,) * 3, (3,) * 3], [(3,) * 3, (3,) * 3], [(3,) * 3, (3,) * 3]]
...
_C.MODEL_ANISO.INPUT_SHAPE = (112, 220, 220)  # # cremi: ZYX (120, 268, 268)
_C.MODEL_ANISO.INPUT_SHAPE_2D = (268, 268)  # cremi
_C.MODEL_ANISO.OUTPUT_SHAPE = (64, 128, 128)  # cremi (72, 144, 144)
_C.MODEL_ANISO.OUTPUT_SHAPE_2D = (144, 144)  # cremi
_C.MODEL_ANISO.VOXEL_SIZE = (40, 4, 4)  # cremi
_C.MODEL_ANISO.VOXEL_SIZE_2D = (4, 4)  # cremi
_C.MODEL_ANISO.LOG_DIR = f"{_C.DATA.HOME}/lsd_logs/{_C.TRAIN.MODEL_TYPE}_{'2D' if _C.DATA.DIM_2D else '3D'}/{_C.DATA.BRAIN_VOL}/{'LSD' if _C.TRAIN.LSD_EPOCHS is not None else ''}/run_2"
_C.MODEL_ANISO.CKPT_FOLDER = f"{_C.DATA.HOME}/lsd_checkpoints/{_C.TRAIN.MODEL_TYPE}_{'2D' if _C.DATA.DIM_2D else '3D'}/{_C.DATA.BRAIN_VOL}/{'LSD' if _C.TRAIN.LSD_EPOCHS is not None else ''}/run_2"
_C.MODEL_ANISO.OUTPUT_DIR = f"{_C.DATA.HOME}/lsd_snapshots/{_C.TRAIN.MODEL_TYPE}_{'2D' if _C.DATA.DIM_2D else '3D'}/{_C.DATA.BRAIN_VOL}/{'LSD' if _C.TRAIN.LSD_EPOCHS is not None else ''}/run_2"
# SPECIAL AUGMENTATION CASE: SET THE PATH TO THE DEFECTS FILE HERE.
