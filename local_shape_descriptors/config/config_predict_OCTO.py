...
_C.SYSTEM.NUM_WORKERS = 80
_C.SYSTEM.CACHE_SIZE = 20
_C.SYSTEM.VERBOSE = True

_C.DATA = CN()
#_C.DATA.HOME = "/net/fibserver1/data/raw/smohinta_data"  # options: /home; /local/path/till/connexion
_C.DATA.HOME = "/media/samia/DATA/mounts/fibserver1/smohinta_data"  
_C.DATA.DATA_DIR_PATH = "catena_data"  # where the code resides and data should too
_C.DATA.BRAIN_VOL = "OCTO_N5"  # datasets, options: HEMI;OCTO;SEYMOUR;LUCCHI;CREMI; expand this to load multiple datasets
...
# prediction specific
_C.DATA.OUTFILE = f"{_C.DATA.HOME}/catena/lsd_outputs" # --------------------------------------------------------
...
# # MongoDB
_C.DATA.DB_NAME = 'lsd_parallel_predictions' # this is default
_C.DATA.DB_HOST = '10.1.0.29:27017' # hex mongo
...
_C.TRAIN.CHECKPOINT = f"/cephfs/smohinta/catena/lsd_checkpoints/MTLSD_3D/run-aclsd-together/model_checkpoint_300000" # -----------------------------------------------------------

if _C.TRAIN.MODEL_TYPE in ["ACLSD", "ACRLSD"]:
    _C.TRAIN.CHECKPOINT_AC = f"{_C.DATA.HOME}/catena/lsd_checkpoints/run_1/model_checkpoint_300000/data" # -----------------------------------------------------------------------
...
_C.MODEL_ISO.INPUT_SHAPE = (256, 256, 256)  # hemi-octo - (196, 196, 196) -----------------------------------------------------------------------------
_C.MODEL_ISO.INPUT_SHAPE_2D = (196, 196)  # hemi-octo -----------------------------------------------------------------------------
# input_shape: Coordinate((172, 172, 172))  # hemi- for gan
_C.MODEL_ISO.OUTPUT_SHAPE = (132, 132, 132)  # hemi-octo (72, 72, 72) -----------------------------------------------------------------------------
...
_C.INS_SEGMENT.THRESHOLDS = np.arange(0.50, 0.80, 0.05).tolist()
