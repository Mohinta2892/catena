...
_C.DATA.BRAIN_VOL = "WASP_PADDED_SAME_PREID" #WASP_MITO  # datasets, options: HEMI;OCTO;SEYMOUR;LUCCHI;CREMI; expand this to load multiple datasets
...
_C.TRAIN.CHECKPOINT = f"/media/samia/DATA/ark/lsd_checkpoints/MTLSD_3D/run-aclsd-together/model_checkpoint_300000"
