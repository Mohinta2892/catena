...
_C.DATA.BRAIN_VOL = 'ZEBRAFINCH_CLAHE_CROPPED'
...
_C.MODEL_ISO.INPUT_SHAPE = (1024, 1024, 1024)
...
_C.MODEL_ISO.LOG_DIR = '/media/samia/DATA/ark/lsd_logs/MTLSD_3D/ZEBRAFINCH_CLAHE_CROPPED//mito_w_incorr_labels'
_C.MODEL_ISO.CKPT_FOLDER = '/media/samia/DATA/ark/lsd_checkpoints/MTLSD_3D/ZEBRAFINCH_CLAHE_CROPPED//mito_hemi_w_incorr_labels'
_C.MODEL_ISO.OUTPUT_DIR = '/media/samia/DATA/ark/lsd_snapshots/MTLSD_3D/ZEBRAFINCH_CLAHE_CROPPED//mito_hemi_w_incorr_labels'
