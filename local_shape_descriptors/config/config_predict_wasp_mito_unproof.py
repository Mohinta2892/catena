...
_C.DATA = CN()
_C.DATA.HOME = "/media/samia/DATA/mounts/zstore1"  # options:/home; /local/path/till/connexion
_C.DATA.DATA_DIR_PATH = "catena/data"  # where the code resides and data should too
_C.DATA.BRAIN_VOL = "WASP_MITO"  # datasets, options: HEMI;OCTO;SEYMOUR;LUCCHI;CREMI; expand this to load multiple datasets
...
_C.TRAIN.CHECKPOINT = f"/media/samia/DATA/ark/lsd_checkpoints/MTLSD_3D/MITO-HEMI/clahed_hemi_mito_unproof/model_checkpoint_300000"
...
_C.MODEL_ANISO.INPUT_SHAPE = (120, 208, 208)  # cremi: (132, 268, 268)
...
_C.INS_SEGMENT.THRESHOLDS = np.arange(0.75, 0.70, 0.05).tolist()
