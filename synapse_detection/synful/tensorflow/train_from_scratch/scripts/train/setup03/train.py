...
data_dir = '/zstore/catena/data/SYN_OCTO_CUBE1/data_3d/train'
data_dir_syn = data_dir
samples = [
    'cutout1_7827_9021_y5622_6798_z4441_5575',
]
# cremi_roi = gp.Roi(np.array((1520, 3644, 3644)), np.array((5000, 5000, 5000)))
hemi_roi_1 = gp.Roi(np.array((0, 0, 0)), np.array((9072, 9408, 9552)))
...
hemi_rois = [hemi_roi_1] #, hemi_roi_2, hemi_roi_3, hemi_roi_4, hemi_roi_5]
