...
JSON_FILES=(
    #"predict_extract_parameters_fb_c1.json"
    #"predict_extract_parameters_fb_c2.json"
    #"predict_extract_parameters_fb_c3.json"
    #"predict_extract_parameters_no_c2.json"
    #"predict_extract_parameters_no_c3.json"
    #"predict_extract_parameters_pb_c1.json"
    "predict_extract_parameters_pb_c2.json"
    "predict_extract_parameters_pb_c3.json"
    )
