...
top_roi_bboxes = pd.read_csv(
    "/net/fibserver1/raw/smohinta_data/local_synapses/bboxes/octo_syncube1_bbox2.csv")  # COORDS of bbox and Synapses here!
...
cluster_files = ['/net/fibserver1/raw/smohinta_data/local_synapses/clusters_octo/synapsecube1_points2.csv',
