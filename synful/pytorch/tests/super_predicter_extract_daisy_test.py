"""
run: python super_predicter_extract_daisy_test.py -c ../config/config_predict_octo.py
"""
...
def predict_blockwise(
    ...
    completed_collection_name = f"{sample_name}_{os.path.basename(cfg.TRAIN.MODEL_TYPE)}_extract_syn"
...
def start_worker(cfg):
    ...
    # worker = "./predict_worker_daisy_test.py"
    worker = "./predict_extract_worker_daisy.py"
