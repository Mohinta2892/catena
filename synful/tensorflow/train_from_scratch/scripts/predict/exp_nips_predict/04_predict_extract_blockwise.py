...
def predict_blockwise(
    ...
    train_dir = '/zstore/synful/scripts/train'
...
def predict_worker(
    ...
    # changed here to be able to read worker script from predict dir
    predict_script = os.path.abspath(os.path.join('/'.join(setup_dir.split('/')[:4]), 'predict', 'predict_and_extract.py'))
